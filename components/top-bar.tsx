...
import { ChevronDown, Search, MapPin, Languages, X } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-evenly">
        ...
        <div className="md:block w-1/2 max-w-3xl">
          <div className="flex items-center bg-white rounded-xl">
            ...
            >
              ...
              <span className="mr-8 text-sm">{selectedCity}</span>
            ...
            <input
              ...
              className="flex-grow bg-transparent border-none focus:outline-none cursor-text text-black"
            />
            <X
              size={24}
        ...
        <Link href="/vendor-space">
          <button
            type="button"
            className={`hidden md:inline-flex py-3 px-4 rounded-xl font-semibold ${
              isDark
